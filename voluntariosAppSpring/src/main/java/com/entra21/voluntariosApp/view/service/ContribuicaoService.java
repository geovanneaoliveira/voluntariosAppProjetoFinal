...
//    public ContribuicaoDTO getById(Long id){
////    ContribuicaoEntity cE= contribuicaoRepository.findById(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.BAD_REQUEST,"Contribuição não encontrado"));
////    ContribuicaoDTO dto= new ContribuicaoDTO();
////    dto.setValor(cE.getValor());
////    dto.setData(cE.getData());
////    dto.setIdOrganizacao(cE.);
//    }
}